"""Draw research/charts/final_accuracy_vs_minutes.png from the .json beside it.

Smooth monotone lines, no dots, plain descriptive titles, log x axis; the second panel is
the share of detectors with enough actuations to get a prediction at all.
"""
import json
import os
...
# .../research/code/evaluation/this.py -> .../research/charts
IMG = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(
    os.path.abspath(__file__)))), "charts")
