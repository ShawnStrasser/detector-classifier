...
bf.WINDOW_SETS["h2"] = WINDOWS_H2

_ORIG_LOAD_CHUNK = bf.load_chunk
_BAD_READY = False
...
def masked_load_chunk(con, devs):
    """`build_features.load_chunk`, then delete every masked ON from `onev_all`."""
...
def main() -> None:
    ...
    bf.load_chunk = masked_load_chunk
