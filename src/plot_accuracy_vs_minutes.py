...
fig, (a1, a2) = plt.subplots(2, 1, figsize=(9.2, 7.8), sharex=True, gridspec_kw={"height_ratios": [2.2, 1], "hspace": 0.22})
...
a1.set_title("Accuracy of predicted phase assignment and detector function", loc="left", fontsize=14, fontweight="bold")
...
a2.set_title("Share of detectors with enough actuations to get a prediction", loc="left", fontsize=14, fontweight="bold")
...
fig.text(0.06, 0.865, "LightGBM beta model, tested on 38 ODOT signals (505 detectors) never seen in training.\n"
         "Sample length from 1 minute to 3 days, averaged over 10 start times across day and night.",
         fontsize=10.5, color=GREY)
fig.subplots_adjust(top=0.81, left=0.09, right=0.97, bottom=0.09)
